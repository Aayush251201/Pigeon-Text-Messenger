...
<head>
  ...
  <link rel="icon" href="img/pig2.png" type="image/x-icon">
  <style>
    * {
  ...
  <div class="col-sm-6 pt-4">
    <div class="card">
      <div class=" p-4 shadow">
        ...
        <p class="card-text">
          Find your friends here, explore the world by making new friends and socialize yourself with your friends.
        </p>
  ...
  <div class="col-sm-6 pt-4">
    <div class="card">
      <div class=" p-4 shadow">
        ...
        <p class="card-text">
         Check if you have unread messages and visit your inbox directly to talk with your friends.
        </p>
